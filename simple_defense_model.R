...
# Compare the dynamics of single and multiple species outputs -----

speciescomp = multipleoutput[,c("P1", "P2")]
multipleoutput[,c("P1", "P2")] = NULL
...
outputall = rbind(singleoutput, multipleoutput)
...
toplot %>% filter(Treatment == "Interaction") %>%
